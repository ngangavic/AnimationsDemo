...
import kotlinx.android.synthetic.main.activity_two_layouts.*

class TwoLayoutsActivity : AppCompatActivity() {
    ...
    fun onClick(view: View) {
        ...
        // Step 3: Call TransitionManager.go() to run animationu
